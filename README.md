...
I've built and deployed products used by real users ,Like **Vellam Undo**, a community-driven platform for reporting and discovering flood-related incidents, led an **award-winning hackathon project**, and contributed to **open source**.
